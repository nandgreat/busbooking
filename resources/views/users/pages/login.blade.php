          ...
          <form method="post" action="{{route('user.post.login')}}">
            ...
            <div class="row">
              ...
              <div style="margin-bottom: 200px">
                <p style="font-size: 50px; font-weight: bold; color: #102983">My Account</p>
                <div class="row">
                  <div class="col-sm-5">
            ...
            <br>
            <div class="border-top card-body text-center mt-sm-6">Dont have an account? <a href="{{route('registration')}}">Create Account</a></div>
          </form>
        </div>
